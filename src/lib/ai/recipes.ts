...
import { createRecipeSystemPrompt, createRecipeUserPrompt } from "./prompts";
...
`,
  ...
  const systemPrompt = createRecipeSystemPrompt(recipeContext);
  const userPrompt = createRecipeUserPrompt(
    mode,
